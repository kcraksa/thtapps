...
@section('title', 'News Management - Edit')
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">News Management - Form Edit</h4>
				</div>
				<div class="card-body">
					<form action="{{ route('news.update', $news->id) }}" id="form-add-news" method="POST">
						...
						<div class="mb-3">
							...
							<textarea class="form-control ckeditor" id="content" name="content" required>{{ $news->content }}</textarea>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3 text-end">
							<button type="submit" class="btn btn-primary" id="btn-save"><span class="fas fa-save"></span> Update</button>
